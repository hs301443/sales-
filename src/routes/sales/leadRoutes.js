...
import { viewAllLeads, getAllSources, /*viewTransferLead, viewDemoLead, viewApproveLead, viewRejectLead,*/ getLeadById, createLead, updateLead, deleteLead, getSalesmanInterestedLeadsCount, getSalesTargetsDetails, getSalesmanLeadsCount, getSalesTargetsCount, HomeSales, getAllCountryAndCity } from '../../controllers/Sales/LeadController.js';
...
router.route('/sources').get(getAllSources);
